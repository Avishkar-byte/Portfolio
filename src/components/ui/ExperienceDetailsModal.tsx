    ...
    return (
        <AnimatePresence>
            {item && (
                ...
                >
                    <motion.div
                        className="relative w-full max-w-4xl sm:w-[95vw] bg-neutral-950/30 backdrop-blur-2xl border border-white/10 rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90dvh]"
