...
const SectionWithMockup: React.FC<SectionWithMockupProps> = ({
    ...
    return (
        <section className={cn("relative py-24 md:py-48 bg-black overflow-hidden min-h-screen flex items-center", className)}>
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            style={{
                                ...
                                // Always push decoration to the outside edge (away from text in center)
                                // If Normal (Image Right): Decoration on Right
                                // If Reverse (Image Left): Decoration on Left
                        ...
                        >
                            <div className="p-0 h-full">
                                <div
                                    ...
                                    style={{
                                        backgroundSize: "cover", // Changed from 100% 100% to separate logic
